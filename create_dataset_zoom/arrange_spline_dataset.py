...
def main():
    ...
    root_path = 'I:/ykato_git/datasets/omg_instance_segmentation/dataset_zoom/img'
    save_path = 'I:/ykato_git/datasets/omg_instance_segmentation/dataset_zoom/ply_render2d'
