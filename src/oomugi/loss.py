...
class DiscriminativeLoss(_Loss):
    ...
    def _discriminative_loss(self, input, target, n_clusters):
        ...
        # print('l_var', l_var) #nan
        # print('l_dist', l_dist)
        # print('l_reg', l_reg) #nan
    ...
    def _cluster_means(self, input, target, n_clusters):
        ...
        for i in range(bs):
            ...
            # print(input_sample.sum(2))
            # print(target_sample.sum(2))
            # print(type(input_sample.sum(2)))
            # print(type(target_sample.sum(2)))
            # print(input_sample.sum(2).shape)
            # print(target_sample.sum(2).shape)
            # print(torch.sum(target_sample == 0))
            # n_features, n_cluster
            mean_sample = input_sample.sum(2) / target_sample.sum(2)

            # print(torch.sum(torch.isnan(mean_sample) == 1))
        ...
        # print(type(means))
        # print(torch.sum(torch.isnan(means) == 1))
    ...
    def _variance_term(self, input, target, c_means, n_clusters):
        ...
        # print(type(c_means))
        # print(type(c_means.cpu().data))
        # print(torch.isnan(c_means.cpu().data))
        # print(torch.sum(torch.isnan(c_means) == 1))
        ...
        for i in range(bs):
            ...
            # print(torch.isnan(target_sample))
